...
RUN pip3 install --no-cache-dir hub-sdk matplotlib pillow pyyaml requests scipy pyarrow pandas tqdm scikit-learn scikit-learn-extra
...
ENV PYTHONPATH="/workspace/resnet:$PYTHONPATH"
